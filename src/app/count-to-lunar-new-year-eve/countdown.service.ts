...
export class CountdownService {
  ...
  constructor() {
    ...
    else  this.convertedToGregorian=  new Date(previousGregorianDate.year, previousGregorianDate.month-1, previousGregorianDate.day);
  ...
  public countMonths(){
    return this.convertedToGregorian.getMonth() - this.today.getMonth()+12;
  }
}
